    ...
    public partial class Initialcreate : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CinemaColors", x => new { x.CinemaId, x.Color });
                    table.ForeignKey(
                        name: "FK_CinemaColors_Cinemas_CinemaId",
                        column: x => x.CinemaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CinemaSubImages", x => new { x.CinemaId, x.Img });
                    table.ForeignKey(
                        name: "FK_CinemaSubImages_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
